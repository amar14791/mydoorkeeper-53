      ...
      <header className="bg-white py-4 fixed top-0 left-0 right-0 z-50 shadow-md">
        <div className="container mx-auto px-4">
          <div className="flex justify-center items-center">
            <img src="/lovable-uploads/538e7a91-aee2-4bde-841a-77872de23b28.png" alt="MyDoorKeeper Logo" className="h-12 w-auto object-contain max-w-[200px]" />
          </div>
        </div>
      </header>
      ...
      <div className="pt-[3rem] md:pt-16">
        <section className="relative min-h-0 md:min-h-screen flex items-start md:items-center justify-center overflow-hidden bg-gradient-to-br from-primary/5 via-white to-secondary/5 pb-16">
          ...
          <div className="container mx-auto px-4 text-center relative animate-fade-up">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto text-center font-semibold text-primary-DEFAULT px-[16px] py-[16px] md:text-4xl">
        ...
        <section id="features" className="py-12 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            ...
            }].map((feature, index) => <div key={index} className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 animate-fade-up border border-gray-100" style={{
          ...
          <div className="container mx-auto px-4 max-w-md">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <Input placeholder="Society Name" value={formData.societyName} onChange={e => setFormData({
                  ...formData,
                  societyName: e.target.value
                })} required className="w-full" />
                </div>
                <div>
                  <Input type="number" placeholder="Number of Flats" value={formData.numberOfFlats} onChange={e => setFormData({
                  ...formData,
                  numberOfFlats: e.target.value
                })} required className="w-full" />
                </div>
                <div>
                  <Input placeholder="Query Type" value={formData.query} onChange={e => setFormData({
                  ...formData,
                ...
                })} required className="w-full min-h-[150px]" />
                </div>
                <Button type="submit" className="w-full bg-viking-teal hover:bg-viking-teal/90" size="lg" disabled={isLoading}>
